    ...
    <div class="container">
        <div class="table-responsive">
            <div class="table-wrapper">
                ...
                <form action="/JEEgotm/PendingController" method="post">
                    ...
                    <tbody >
		                ...
		                <tr>
		                    ...
		                    <td><input type="checkbox" name="selectedUsers" value="${user.idpending}"></td>
		                    <td>
							    <form action="/JEEgotm/PendingController" method="post">
							        <input type="hidden" name="id" value="${user.idpending}">
                ...
                <input type="submit" style="color:black;" value="Promote Selected Users" />
                </form>
